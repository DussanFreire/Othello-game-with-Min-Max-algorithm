...
class Board:
    ...
    def create_empty_board(self):
        self.cells = np.array([[Cell(Settings.empty_token), Cell(Settings.empty_token),
                                Cell(Settings.empty_token), Cell(Settings.empty_token),
                                Cell(Settings.empty_token), Cell(Settings.empty_token),
                                Cell(Settings.empty_token), Cell(Settings.empty_token)],
                               [Cell(Settings.empty_token), Cell(Settings.empty_token),
                                Cell(Settings.empty_token), Cell(Settings.empty_token),
                               ...
                               [Cell(Settings.empty_token), Cell(Settings.empty_token),
                                ...
                                Cell(Settings.empty_token), Cell(Settings.empty_token)],
                               [Cell(Settings.empty_token), Cell(Settings.empty_token),
                                Cell(Settings.empty_token), Cell(Settings.p1_token),
                                Cell(Settings.p2_token), Cell(Settings.empty_token),
                                Cell(Settings.empty_token), Cell(Settings.empty_token)],
                               [Cell(Settings.empty_token), Cell(Settings.empty_token),
                                Cell(Settings.empty_token), Cell(Settings.p2_token),
                                Cell(Settings.p1_token), Cell(Settings.empty_token),
                                Cell(Settings.empty_token), Cell(Settings.empty_token)],
                               [Cell(Settings.empty_token), Cell(Settings.empty_token),
                                Cell(Settings.empty_token), Cell(Settings.empty_token),
                                Cell(Settings.empty_token), Cell(Settings.empty_token),
